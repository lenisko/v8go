...
<a href="https://github.com/lenisko/v8go/releases"><img src="https://img.shields.io/github/v/release/lenisko/v8go" alt="Github release"></a>
[![Go Report Card](https://goreportcard.com/badge/github.com/lenisko/v8go)](https://goreportcard.com/report/github.com/lenisko/v8go)
[![Go Reference](https://pkg.go.dev/badge/github.com/lenisko/v8go.svg)](https://pkg.go.dev/github.com/lenisko/v8go)
[![Test](https://github.com/lenisko/v8go/actions/workflows/test.yml/badge.svg)](https://github.com/lenisko/v8go/actions/workflows/test.yml)
...
```go
import v8 "github.com/lenisko/v8go"
```
...
Go Reference & more examples: https://pkg.go.dev/github.com/lenisko/v8go
...
We have the [v8upgrade](https://github.com/lenisko/v8go/.github/workflow/v8upgrade.yml) workflow.
...
The [v8build](https://github.com/lenisko/v8go/.github/workflow/v8build.yml) workflow upgrades V8 and builds the libraries.
...
The [syncsubdeps](https://github.com/lenisko/v8go/.github/workflow/syncsubdeps.yml) workflow updates the `go.mod` file to point to the new commit.
...
Releasing the library is a matter of running the [release](https://github.com/lenisko/v8go/.github/workflow/release.yml) workflow.
